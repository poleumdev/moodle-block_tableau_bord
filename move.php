...
/**
 * Move/order course functionality for tableau_bord block.
 *
 ...
 */
 ...
 //A supprimer on ne deplace plus les cours !!
...
list($courses, $sitecourses, $coursecount) = block_tableau_bord_get_sorted_courses();
...
block_tableau_bord_update_myorder(array_values($neworder));
redirect(new moodle_url('/my/index.php'));
