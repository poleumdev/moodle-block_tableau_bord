...
M.block_tableau_bord.add_handles = function(Y) {
    ...
    YUI().use('dd-constrain', 'dd-proxy', 'dd-drop', 'dd-plugin', function(Y) {
        ...
        Y.DD.DDM.on('drag:start', function(e) {
            ...
            drag.get('dragNode').addClass('block_tableau_bord');
...
M.block_tableau_bord.save = function() {
    ...
    Y.io(M.cfg.wwwroot + '/blocks/tableau_bord/save.php', {
        method: 'POST',
 ...
 */
M.block_tableau_bord.collapsible = function(Y, id, userpref, strtooltip) {
    if (userpref) {
        M.block_tableau_bord.userpref = true;
    }
    Y.use('anim', function(Y) {
        new M.block_tableau_bord.CollapsibleRegion(Y, id, userpref, strtooltip);
    });
};
 ...
 * @param {String} strtooltip
 */
M.block_tableau_bord.CollapsibleRegion = function(Y, id, userpref, strtooltip) {
...
M.block_tableau_bord.userpref = false;
 ...
 * @type String
 */
M.block_tableau_bord.CollapsibleRegion.prototype.userpref = null;
 ...
 * @type Y.Node
 */
M.block_tableau_bord.CollapsibleRegion.prototype.div = null;
 ...
 * @type Y.Node
 */
M.block_tableau_bord.CollapsibleRegion.prototype.icon = null;
